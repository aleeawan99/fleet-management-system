...
public class TruckParameterFragment extends Fragment{

    private static final String TAG = "Truck Parameter";
    ...
    int i;
    private TextView temperature_text_v, humidity_text_v, speed_text_v, engine_rpm_text_v, engine_load_text_v, coolant_text_v;
    ...
    Boolean isNotify = true, isTempNotify = true;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        runnable = new Runnable() {
            @Override
            public void run() {
                String Url = Constant.URL1 + "Truck-1/temperature" + Constant.URL2;
                call(Url);
        ...
        runnable1 = new Runnable() {
            @Override
            public void run() {
                String Url = Constant.URL1 + "Truck-1/humidity" + Constant.URL2;
                call(Url);
        ...
        runnable2 = new Runnable() {
            @Override
            public void run() {
                String Url = Constant.URL1 + "Truck-1/speed" + Constant.URL2;
                call(Url);
        ...
        runnable3 = new Runnable() {
            @Override
            public void run() {
                String Url = Constant.URL1 + "Truck-1/rpm" + Constant.URL2;
                call(Url);
                handler3.postDelayed(this, 800);
            }
        };
        ...
        runnable4 = new Runnable() {
            @Override
            public void run() {
                String Url = Constant.URL1 + "Truck-1/EngineLoad" + Constant.URL2;
                call(Url);
                handler4.postDelayed(this, 800);
            }
        };
        ...
        runnable5 = new Runnable() {
            @Override
            public void run() {
                String Url = Constant.URL1 + "Truck-1/CoolentTemp" + Constant.URL2;
                call(Url);
                handler5.postDelayed(this, 800);
            }
        };
    ...
    public void setTemperature_meter(int temp){
        ...
        temperature_text_v.setText(Integer.toString(temperature_meter.getValue())+ "\u2103");
    }
    ...
    public void setSpeedmeter(int speed){
        ...
        if (mySharedPreference.getAlertsData(Constant.SPEED_ALERT)) {
            try {
                if (speed > Integer.valueOf(mySharedPreference.getOverSpeedLimit(Constant.SPEED_LIMIT))) {
                    if (isNotify) {
                        sendNotification("Truck exceeds speed limit.");
                        isNotify = false;
                    }
                } else
                    isNotify = true;
    ...
    public void setCoolant_temperature_meter(int temp){
        if (mySharedPreference.getAlertsData(Constant.TEMP_ALERT)) {
            try {
                if (temp > Integer.valueOf(mySharedPreference.getOverSpeedLimit(Constant.TEMP_LIMIT))) {
                    if (isTempNotify) {
                        sendNotification("Truck Coolant Temperature Exceeded limit.");
                        isTempNotify = false;
                    }
                } else
                    isTempNotify = true;
